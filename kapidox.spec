...
Version  : 6.1.0
Release  : 114
URL      : https://download.kde.org/stable/frameworks/6.1/kapidox-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kapidox-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kapidox-6.1.0.tar.xz.sig
...
%setup -q -n kapidox-6.1.0
cd %{_builddir}/kapidox-6.1.0
pushd ..
cp -a kapidox-6.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712949573
