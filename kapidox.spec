...
Version  : 6.6.0
Release  : 122
URL      : https://download.kde.org/stable/frameworks/6.6/kapidox-6.6.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.6/kapidox-6.6.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.6/kapidox-6.6.0.tar.xz.sig
...
%setup -q -n kapidox-6.6.0
cd %{_builddir}/kapidox-6.6.0
pushd ..
cp -a kapidox-6.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726431829
