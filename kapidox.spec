...
Source0  : https://download.kde.org/stable/frameworks/5.65/kapidox-5.65.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.65/kapidox-5.65.0.tar.xz.sig
...
%prep
%setup -q -n kapidox-5.65.0
cd %{_builddir}/kapidox-5.65.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576512932
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kapidox-5.65.0/LICENSE %{buildroot}/usr/share/package-licenses/kapidox/4f348e8e16c398ae808b12f1f31c8f32041f80fc
cp %{_builddir}/kapidox-5.65.0/src/kapidox/data/htmlresource/3rd-party/bootstrap/LICENSE.txt %{buildroot}/usr/share/package-licenses/kapidox/26d8bcc8dbe50e51ae48a8124935dc704d01add2
cp %{_builddir}/kapidox-5.65.0/src/kapidox/data/htmlresource/3rd-party/jquery/LICENSE.txt %{buildroot}/usr/share/package-licenses/kapidox/1238983d71130d0d96aad2acc946818007c77734
pushd clr-build
%make_install
popd
