...
Version  : 5.114.0
Release  : 106
URL      : https://download.kde.org/stable/frameworks/5.114/kapidox-5.114.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.114/kapidox-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/kapidox-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kapidox-5.114.0
cd %{_builddir}/kapidox-5.114.0
%patch -P 1 -p1
pushd ..
cp -a kapidox-5.114.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705440112
