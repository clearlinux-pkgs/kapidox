...
Source0  : https://download.kde.org/stable/frameworks/5.52/kapidox-5.52.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.52/kapidox-5.52.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1541864521
mkdir -p clr-build
pushd clr-build
%cmake ..
